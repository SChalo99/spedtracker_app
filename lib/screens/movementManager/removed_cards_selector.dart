...
class RemovedCardMScreen extends StatefulWidget {
  final String userToken;
  const RemovedCardMScreen({super.key, required this.userToken});

  @override
  State<RemovedCardMScreen> createState() => _RemovedCardMScreenState();
}


class _RemovedCardMScreenState extends State<RemovedCardMScreen> {
